            ...
            <div className="navbar8-buttons1">
              <button className="navbar8-action11 thq-button-animated thq-button-filled">
                <span>
                  {props.action1 ?? (
                    <Fragment>
                      <span className="navbar8-text15">Join WhatsApp</span>
                    </Fragment>
                  )}
                </span>
              </button>
              <button className="navbar8-action21 thq-button-outline thq-button-animated">
                <span>
                  {props.action2 ?? (
                    <Fragment>
                      <span className="navbar8-text27">Upcoming Event</span>
                    </Fragment>
                  )}
                </span>
              </button>
                  ...
                  <div className="navbar8-menu-item6">
                    ...
                    <div className="navbar8-content6">
                      <span className="navbar8-page22 thq-body-large">
                        {props.page2 ?? (
                          <Fragment>
                            <span className="navbar8-text20">Runners</span>
                          </Fragment>
                        )}
                      </span>
                      <span className="thq-body-small">
...
Navbar8.defaultProps = {
  ...
  page1ImageSrc:
    'https://images.unsplash.com/photo-1722108926139-66ce87857ce9?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc0ODE5NDIxMXw&ixlib=rb-4.1.0&q=80&w=1080',
  action1: undefined,
  page2ImageAlt: 'Avatar of a runner in Alpha Run Club',
  link2: undefined,
  linkUrlPage2: 'https://www.teleporthq.io',
  logoAlt: 'Alpha Run Club Logo',
  logoSrc:
    'https://aheioqhobo.cloudimg.io/v7/_playground-bucket-v2.teleporthq.io_/84ec08e8-34e9-42c7-9445-d2806d156403/fac575ac-7a41-484f-b7ac-875042de11f8?org_if_sml=1&force_format=original',
  page3ImageAlt: 'Image of an event in Alpha Run Club',
  linkUrlPage1: 'https://www.teleporthq.io',
  page1: undefined,
  link1: undefined,
  page4ImageSrc:
    'https://images.unsplash.com/photo-1526324502790-ad8c7c6076df?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc0ODE5NDIxMnw&ixlib=rb-4.1.0&q=80&w=1080',
  linkUrlPage3: 'https://www.teleporthq.io',
  page4: undefined,
  page2: undefined,
  link4: undefined,
  page4ImageAlt: 'Contact image for Alpha Run Club',
  page1Description: undefined,
  page2ImageSrc:
    'https://images.unsplash.com/photo-1641893872557-5f561359474d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc0ODE5NDIxMnw&ixlib=rb-4.1.0&q=80&w=1080',
  page3ImageSrc:
    'https://images.unsplash.com/photo-1659356543344-3da5156fd6f2?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc0ODE5NDIxMnw&ixlib=rb-4.1.0&q=80&w=1080',
  page2Description: undefined,
  link3: undefined,
  page3: undefined,
  link1Url: 'https://www.teleporthq.io',
  page3Description: undefined,
  page1ImageAlt: 'Image of runners in Alpha Run Club',
  action2: undefined,
